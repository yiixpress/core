 ...
 */
class BlogCategoryBase extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return BlogCategory the static model class
	 */
	public static function model($className = 'BlogCategory')
	{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, name, alias, parent_id, status, date_added, date_updated', 'safe', 'on' => 'search'),
		);
	}
