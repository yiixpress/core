...
class ContentCode extends CCodeModel
{
	public $model;
	public $controller;
	public $baseControllerClass='ContentBaseController';
	...
	public function getControllerClass()
	{
		if(($pos=strrpos($this->controller,'/'))!==false)
			return ucfirst(substr($this->controller,$pos+1)).'ContentController';
		else
			return ucfirst($this->controller).'ContentController';
	}
	...
	public function getControllerFile()
	{
		...
		return $module->getControllerPath().'/'.$id.'ContentController.php';
	}

	public function getViewPath()
	{
		return $this->getModule()->getViewPath().'/'.$this->getControllerID().'Content';
	}
