 ...
 *
 * The followings are the available columns in table 'tagrem_indition2_admin_user':
 * @property integer $id
 ...
 */
class AdminUserBase extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return AdminUser the static model class
	 */
	public static function model($className='AdminUser')
	{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, email, password, last_login, validation_code, validation_type, validation_expired, status, creation_datetime, last_update', 'safe', 'on'=>'search'),
		);
	}
